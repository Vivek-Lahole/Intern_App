...
public class MycropsAdapter extends RecyclerView.Adapter<MycropsAdapter.ExampleViewHolder> {
   ...
   // String s=String.valueOf(Daybetween("2020-10-20",todayString,"yyyy-mm-dd"));
    ...
    public MycropsAdapter(ArrayList<Fav_commodities> exampleList) {
        mExampleList = exampleList;
    }
    @Override
    public ExampleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.mycrops_card, parent, false);
