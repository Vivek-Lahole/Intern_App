...
public class CropViewAdapter extends RecyclerView.Adapter<CropViewAdapter.ExampleViewHolder> {
    private ArrayList<CropViewCommodity> mExampleList;
    private OnItemClickListener mListener;
    private OnCardClickListener1 mcardListener;
    ...
    public interface OnCardClickListener1 {
        void onCardClick(View view, int position);

    }

    public void setOnCardClickListener1(OnCardClickListener1 listener) {
    ...
    public static class ExampleViewHolder extends RecyclerView.ViewHolder {
        ...
        public ExampleViewHolder(View itemView, final OnItemClickListener listener, final OnCardClickListener1 listener2) {
            super(itemView);
            ...
            state=itemView.findViewById(R.id.textView39);
    ...
    public CropViewAdapter(ArrayList<CropViewCommodity> exampleList) {
        mExampleList = exampleList;
    }

    @Override
    public ExampleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.commodity_card_cropview, parent, false);
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        CropViewCommodity currentItem = mExampleList.get(position);
    ...
    public void updateList(ArrayList<CropViewCommodity> list) {
        mExampleList = list;
    ...
    */
    ...
    public CropViewCommodity getItem(int position) {
