...
public class MandisAdapter extends RecyclerView.Adapter<MandisAdapter.ExampleViewHolder>  {
   ...
   // private ArrayList<mandis> mandisFiltered;
    ...
    public MandisAdapter(ArrayList<mandis> exampleList,Context ctx) {
    ...
    public class MyMenuItemClickListener implements PopupMenu.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.item1:
                    // ...
                    System.out.println("**************************item1 clciked");
                    return true;
                case R.id.item2:
                    // ...
